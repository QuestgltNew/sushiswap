...
// ApesRoll helps your migrate your existing Uniswap LP tokens to ApesSwap LP ones
contract ApesRoll {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, 'ApesSwap: EXPIRED');
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'ApesRoll: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'ApesRoll: INSUFFICIENT_B_AMOUNT');
    }
